...
import (
	...
	"github.com/m0a-mystudy/gae-chat/client"
	"github.com/m0a-mystudy/gae-chat/tool/cli"
...
func main() {
	...
	app := &cobra.Command{
		Use:   "GAE Chat API-cli",
		Short: `CLI client for the GAE Chat API service`,
	}
	...
	c.UserAgent = "GAE Chat API-cli/0"
